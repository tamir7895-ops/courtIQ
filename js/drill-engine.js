...
const _DRILLS_DB = [
  ...
  /* ──────────── 2026-07 additions — solo essentials ───────── */
  {
    id: 'shoot-036',
    name: 'Beat the Pro Shooting Game',
    description: 'Pick a spot and an imaginary pro. Every make is +1 for you, every miss is +2 for the pro; first to 11 wins. Scorekeeping under consequence turns lazy reps into game shots — if the pro keeps winning, step in a level, not up.',
    duration_minutes: 15,
    reps_or_sets: 'Games to 11, 3-5 games',
    difficulty: 'Intermediate',
    focus_area: 'Shooting',
    equipment_needed: ['Basketball', 'Hoop'],
    positions: ['PG', 'SG', 'SF', 'PF', 'C'],
  ...
  },
  {
    ...
    description: 'Five spots along the arc, corner to corner. Advance on a make, stay on a miss — miss twice and you go back one spot. Full circuit and back. The classic for a reason: it punishes rushing and rewards a repeatable routine at every station.',
    duration_minutes: 15,
    reps_or_sets: 'Full circuit there and back',
    difficulty: 'Beginner',
    focus_area: 'Shooting',
    equipment_needed: ['Basketball', 'Hoop'],
    positions: ['PG', 'SG', 'SF', 'PF', 'C'],
  ...
  {
    id: 'shoot-038',
    name: 'Relocation Threes',
    description: 'Shoot from the wing, then immediately slide two hard steps along the arc to a new spot, catch your own rebound pass off the toss, and shoot again. Great shooters are moving targets — the shot after relocation is the one defenses give up.',
    duration_minutes: 14,
    reps_or_sets: '4 sets × 8 shots per side',
    difficulty: 'Advanced',
    focus_area: 'Shooting',
    equipment_needed: ['Basketball', 'Hoop'],
    positions: ['PG', 'SG', 'SF'],
  ...
  },
  {
    ...
    description: 'The Mikan rhythm, but finishing on the opposite side of the rim with a reverse layup — step under the basket, protect the ball with your body, finish high off the glass. Builds the escape-hatch finish for when a shot-blocker meets you at the rim.',
    duration_minutes: 8,
    reps_or_sets: '3 sets × 10 makes',
    difficulty: 'Intermediate',
    focus_area: 'Finishing',
    equipment_needed: ['Basketball', 'Hoop'],
    positions: ['PG', 'SG', 'SF', 'PF', 'C'],
  ...
  {
    id: 'bh-031',
    name: 'Daily 10-Minute Handle Routine',
    description: 'One song-length block each of pound dribbles, crossovers, between-the-legs, behind-the-back and two-ball — both hands, eyes up the whole time. Not a workout, a habit: ten minutes every day beats an hour once a week for hand speed.',
    duration_minutes: 10,
    reps_or_sets: '5 blocks × 2 minutes',
    difficulty: 'Beginner',
    focus_area: 'Ball Handling',
    equipment_needed: ['Basketball'],
    positions: ['PG', 'SG', 'SF', 'PF', 'C'],
  ...
  {
    id: 'cond-031',
    name: 'Change-of-Pace Sprint Ladder',
    description: 'Alternate gears on court lengths: jog to the free-throw line, sprint to half, cruise to the far free-throw line, burst to the baseline. Basketball is never one speed — training the gear change is what makes the first step feel explosive in the fourth quarter.',
    duration_minutes: 12,
    reps_or_sets: '8-10 lengths with gear changes',
    difficulty: 'Intermediate',
    focus_area: 'Conditioning',
    equipment_needed: [],
    positions: ['PG', 'SG', 'SF', 'PF', 'C'],
  ...
  {
    id: 'foot-016',
    name: '1-2 Step vs Hop Catch Footwork',
    description: 'Toss the ball out, arrive into the catch two ways: inside-foot 1-2 step going right, then the two-foot hop. Ten reps each, then mix on instinct. Owning both catches is what makes your release time identical from every spot.',
    duration_minutes: 12,
    reps_or_sets: '3 sets × 10 per style',
    difficulty: 'Beginner',
    focus_area: 'Footwork',
    equipment_needed: ['Basketball', 'Hoop'],
    positions: ['PG', 'SG', 'SF', 'PF'],
  ...
  {
    id: 'str-026',
    name: 'Pogo Jump Stiffness Series',
    description: 'Small, fast, stiff-ankle bounces — minimal knee bend, minimal ground time, like dribbling the floor with your feet. Two-leg, then single-leg. Builds the ankle spring that protects knees on landings and adds bounce to your second jump.',
    duration_minutes: 8,
    reps_or_sets: '4 sets × 20 contacts',
    difficulty: 'Beginner',
    focus_area: 'Strength',
    equipment_needed: [],
    positions: ['PG', 'SG', 'SF', 'PF', 'C'],
