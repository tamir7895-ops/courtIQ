...
const MeApp = () => {
  ...
  const onEarn = () => {
    window.location.href = "drill-library.html";
  };
      ...
      <Frame width={390} height={844} dark>
        <div style={{ position: "absolute", inset: 0, background: "#06080c", overflow: "hidden" }}>
          <window.MeScreen
            ...
            onCustomize={() => { window.location.href = "avatar-customizer.html"; }}
            ...
            onEarn={onEarn}
          />
          <window.CIQBottomNav active={activeNav} onChange={(id) => { setActiveNav(id); window.ciqNavTo(id, "me"); }} />
